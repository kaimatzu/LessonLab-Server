...
export async function createPrompt(messages: any[], namespaceId: string) {
  try {
    ...
    const prompt = [
      {
        role: "system",
        content: `AI assistant is a brand new, powerful, lesson generator artificial intelligence that will generate a lesson material.
      ...
      AI assistant will generate a lesson material based on what the user will ask.
